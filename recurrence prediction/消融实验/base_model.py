...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        best_epoch = epoch + 1
        print(f"-> Best validation epoch updated: {best_epoch}, Validation Accuracy: {best_val_acc:.4f}")

# ==================================================
# 10️⃣ 最终测试（仅在测试集上评估一次）
# ==================================================
...
plt.title("t-SNE Visualization of Fused Features (Test Set)")
plt.xlabel("t-SNE 1")
plt.ylabel("t-SNE 2")
plt.legend()
plt.show()
